...
#ifndef FIRETRACKER_SWIFT_H
#define FIRETRACKER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FIRETracker",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC11FIRETracker17WatchSnapshotSync")
@interface WatchSnapshotSync : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class WCSession;
@class NSString;
@interface WatchSnapshotSync (SWIFT_EXTENSION(FIRETracker)) <WCSessionDelegate>
